...
export const DEFAULT_PLANETS: Planet[] = [
  { id: 'planet-0', name: 'Elouith', index: 0, materials: 0, cards: 2, symbols: ['Tech'], isFirstPlanet: true, conquestCardId: '01166' },
  { id: 'planet-1', name: 'Iridial', index: 1, materials: 1, cards: 0, symbols: ['Strongpoint', 'Tech', 'Material'], isFirstPlanet: false, conquestCardId: '01167' },
  ...
  { id: 'planet-4', name: 'Tarrus', index: 4, materials: 1, cards: 1, symbols: ['Material', 'Strongpoint'], isFirstPlanet: false, conquestCardId: '01170' },
